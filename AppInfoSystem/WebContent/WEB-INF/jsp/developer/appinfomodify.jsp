          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input id="statusName" type="text" class="form-control col-md-7 col-xs-12" 
              	name="statusName" value="${appInfo.statusName}" readonly="readonly"> <span style="color:red">${statusError }</span>
            </div>
          </div>
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				...
				<p><span style="color:red;font-weight: bold;"><c:if test="${fileUploadError==null }">*注：1、大小不得超过500k.2、图片格式：jpg、png、jpeg、pneg</c:if>${fileUploadError }</span></p>
				</div>
				<div id="logoFile"></div>
