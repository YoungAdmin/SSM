        ...
        <div class="right">
			...
			<input type="hidden" id="totalPageCount" value="${totalPageCount}"/>
          	...
          	<div class="providerAdd">
				...
				<div>
					<label>出生日期：</label>
					<input type="text" id="v_birthday" class="Wdata" value="" readonly="readonly" onclick="WdatePicker();">
				</div>
				<div>
					<label>用户电话：</label>
				...
				<div>
					<label>创建日期：</label>
					<input type="text" id="v_creationDate" class="Wdata" value="" readonly="readonly" onclick="WdatePicker();">
				</div>
			</div>
        </div>
    </section>
